...
SEARCH.bottom_page_html = function(e, k, j) {
    ...
    if (e <= 1) {
        ...
        f += '<a onclick="SEARCH.page(' + d + ', true)" href="javascript:11111111;" class="prev" title="使用方向键左键也可翻到上一页哦！">上一页<b></b></a>'
    }
    for (var h = 1; h <= k; h++) {
        if (h <= 2 || h >= a && h <= b) {
            f += h == e ? '<a href="javascript:;" class="current">' + h + "</a>" : '<a onclick="SEARCH.page(' + (j ? 2 * h - 1 : h) + ', true)" href="javascript:333333;">' + h + "</a>"
        } else {
            if (h < a) {
    ...
    if (e >= k) {
        ...
        f += '<a onclick="SEARCH.page(' + g + ', true)" href="javascript:22222222;" class="next" title="使用方向键右键也可翻到下一页哦！">下一页<b></b></a>'
    }
...
SEARCH.page = function(b, a) {
    ...
    window.location = "http://localhost:8083/search.html?q="+SEARCH.query+"&page="+b;
//    if (a) {
